...
class MemoryType(StrEnum):
    ...
    FIRMWARE_ENGINEERING_RESULT = "FIRMWARE_ENGINEERING_RESULT"
    HIL_VALIDATION_RESULT = "HIL_VALIDATION_RESULT"
    OPTIMIZATION_ANALYSIS_RESULT = "OPTIMIZATION_ANALYSIS_RESULT"
    ENGINEERING_KNOWLEDGE_RESULT = "ENGINEERING_KNOWLEDGE_RESULT"
